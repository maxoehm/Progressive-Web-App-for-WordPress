...
public class QehrgUsermetaService {
  ...
  @Inject
  public QehrgUsermetaService(
      QehrgUsermetaRepository qehrgUsermetaRepository, QehrgUserRepository qehrgUserRepository) {
  ...
  public List<QehrgUsermeta> findByUserIdAndGetProfileFields(Long userId) {
    ...
    String[] metaKeys = {
      "first_name", "last_name", "mepr-address-one", "mepr-address-city", "mepr-address-zip"
    };
