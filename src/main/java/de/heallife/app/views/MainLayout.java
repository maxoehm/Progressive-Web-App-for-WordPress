...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("HealLife App");
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Events", "lab la-angellist", EventsView.class), //

                new MenuItemInfo("profile", "la la-user", ProfileView.class), //

                new MenuItemInfo("Blog", "la la-book-reader", BlogView.class), //

                new MenuItemInfo("subscribe", "la la-subscript", SubscribeView.class), //
