package de.heallife.app.views.subscribe;
...
@PermitAll
@Tag("subscribe-view")
@JsModule("./views/subscribe/subscribe-view.ts")
public class SubscribeView extends LitTemplate implements HasStyle {
  ...
  @Id private ComboBox countrySelect;
  @Id private ComboBox stateSelect;
