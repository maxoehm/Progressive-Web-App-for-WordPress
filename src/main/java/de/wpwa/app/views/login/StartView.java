...
public class StartView extends FlexLayout implements HasUrlParameter<String> {
    ...
    Html html =
        new Html(
            "<iframe width=\"560\" height=\"315\""
                + " src=\"https://www.youtube-nocookie.com/embed/AL_77M46fwk\" title=\"YouTube"
  ...
  private void buildChorome() {
    ...
    Html html =
        new Html(
            "<a href='https://play.google.com/store/apps/details?id=de.heallife.app.twa&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img"
