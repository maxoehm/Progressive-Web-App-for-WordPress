package de.wpwa.app.views.profile;
...
import de.wpwa.app.security.AuthenticatedUser;
...
public class ProfileView extends Div {
            ...
            event -> {
              if (hasNotBeenTriggered.get()) {
                Notification notification =
                    new Notification(
                        "Deine Email Adresse kannst du auf der Website (heallife.de) ändern.");
  ...
  private Component createFormLayout() {
    ...
    formLayout.setResponsiveSteps(
        new FormLayout.ResponsiveStep("0", 1), new FormLayout.ResponsiveStep("100px", 2));
