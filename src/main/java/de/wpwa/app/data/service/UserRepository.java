...
public interface UserRepository extends JpaRepository<User, Integer> {
  ...
  @Query(value = "select * from _users as u where u.user_nicename = :name", nativeQuery = true)
  User findByCustomQuery(@Param("name") String name);

  @Query(value = "select * from _users as u where u.user_email = :email", nativeQuery = true)
